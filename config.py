...
def parse_config() -> AppConfig:
    ...
    parser.add_argument("--video-in", default="./data/input/traffic2.mp4")
    parser.add_argument("--video-out", default="./data/output/output.avi")
    parser.add_argument("--images-dir", default="./data/images_in")
    parser.add_argument("--images-per-second", type=float, default=30.0)
    parser.add_argument("--fast-video", action="store_true", default=True)
    parser.add_argument("--no-fast-video", action="store_false", dest="fast_video")
    parser.add_argument("--frame-queue-size", type=int, default=512)
    ...
    parser.add_argument("--conf-threshold-low", type=float, default=0.20)
    ...
    parser.add_argument("--ocr-min-wait", type=float, default=0.2)
