...
def main() -> None:
    ...
    if not vehicle_class_ids:
        vehicle_class_ids = {idx for idx in class_name_map.keys() if idx not in plate_class_ids}
    ...
    try:
        ...
        while not SHOULD_STOP:
            ...
            for det in detection_entries:
                if det["class_id"] in plate_class_ids:
                    plate_detections.append(det)
                elif det["class_id"] in vehicle_class_ids:
